...
if __name__ == "__main__":
    ...
    dataset = CelebAWithID(root="/home/dknigge/data/", train=True, download=False)
    img, target, idx = dataset[0]
    print(np.asarray(img).shape, target, idx)
